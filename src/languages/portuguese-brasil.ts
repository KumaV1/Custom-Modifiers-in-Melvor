export const ptBR = {
    ...
    MONSTER_TYPE_NAME_PLURAL_Animal: "Animais",
    MONSTER_TYPE_NAME_SINGULAR_Demon: "Demônio",
    MONSTER_TYPE_NAME_PLURAL_Demon: "Demônios",
    MONSTER_TYPE_NAME_SINGULAR_Dragon: "Dragão",
    MONSTER_TYPE_NAME_PLURAL_Dragon: "Dragões",
    MONSTER_TYPE_NAME_SINGULAR_Elemental: "Elementar",
    MONSTER_TYPE_NAME_PLURAL_Elemental: "Elementais",
    MONSTER_TYPE_NAME_SINGULAR_Elf: "Elfo",
    MONSTER_TYPE_NAME_PLURAL_Elf: "Elfos",
    MONSTER_TYPE_NAME_SINGULAR_Human: "Humanos",
    MONSTER_TYPE_NAME_PLURAL_Human: "Humanos",
    MONSTER_TYPE_NAME_SINGULAR_MythicalCreature: "Criatura mítica",
    MONSTER_TYPE_NAME_PLURAL_MythicalCreature: "Criaturas míticas",
    MONSTER_TYPE_NAME_SINGULAR_SeaCreature: "Criatura marinha",
    MONSTER_TYPE_NAME_PLURAL_SeaCreature: "Criaturas marinhas",
    MONSTER_TYPE_NAME_SINGULAR_Undead: "Morto-vivo",
    MONSTER_TYPE_NAME_PLURAL_Undead: "Morto-vivo",

export const ko = {
    ...
    MONSTER_TYPE_NAME_SINGULAR_Animal: "동물",
    MONSTER_TYPE_NAME_PLURAL_Animal: "동물",
    MONSTER_TYPE_NAME_SINGULAR_Demon: "악마",
    MONSTER_TYPE_NAME_PLURAL_Demon: "악마",
    MONSTER_TYPE_NAME_SINGULAR_Dragon: "드래곤",
    MONSTER_TYPE_NAME_PLURAL_Dragon: "드래곤",
    MONSTER_TYPE_NAME_SINGULAR_Elemental: "원소",
    MONSTER_TYPE_NAME_PLURAL_Elemental: "원소",
    MONSTER_TYPE_NAME_SINGULAR_Elf: "엘프",
    MONSTER_TYPE_NAME_PLURAL_Elf: "엘프",
    MONSTER_TYPE_NAME_SINGULAR_Human: "인간",
    MONSTER_TYPE_NAME_PLURAL_Human: "인간",
    MONSTER_TYPE_NAME_SINGULAR_MythicalCreature: "신화 생물",
    MONSTER_TYPE_NAME_PLURAL_MythicalCreature: "신화 생물",
    MONSTER_TYPE_NAME_SINGULAR_SeaCreature: "바다 생물",
    MONSTER_TYPE_NAME_PLURAL_SeaCreature: "바다 생물",
    MONSTER_TYPE_NAME_SINGULAR_Undead: "언데드",
    MONSTER_TYPE_NAME_PLURAL_Undead: "언데드",

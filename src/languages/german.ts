export const de = {
    ...
    MONSTER_TYPE_NAME_SINGULAR_Animal: "Tier",
    MONSTER_TYPE_NAME_PLURAL_Animal: "Tiere",
    MONSTER_TYPE_NAME_SINGULAR_Demon: "Dämon",
    MONSTER_TYPE_NAME_PLURAL_Demon: "Dämonen",
    MONSTER_TYPE_NAME_SINGULAR_Dragon: "Drache",
    MONSTER_TYPE_NAME_PLURAL_Dragon: "Drachen",
    MONSTER_TYPE_NAME_SINGULAR_Elemental: "Elementar",
    MONSTER_TYPE_NAME_PLURAL_Elemental: "Elementare",
    MONSTER_TYPE_NAME_SINGULAR_Elf: "Elfe",
    MONSTER_TYPE_NAME_PLURAL_Elf: "Elfen",
    MONSTER_TYPE_NAME_SINGULAR_Human: "Mensch",
    MONSTER_TYPE_NAME_PLURAL_Human: "Menschen",
    MONSTER_TYPE_NAME_SINGULAR_MythicalCreature: "Fabelwesen",
    MONSTER_TYPE_NAME_PLURAL_MythicalCreature: "Fabelwesen",
    MONSTER_TYPE_NAME_SINGULAR_SeaCreature: "Meereslebewesen",
    MONSTER_TYPE_NAME_PLURAL_SeaCreature: "Meereslebewesen",
    MONSTER_TYPE_NAME_SINGULAR_Undead: "Untoter",
    MONSTER_TYPE_NAME_PLURAL_Undead: "Untote",

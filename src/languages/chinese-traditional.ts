export const zhTW = {
    ...
    MONSTER_TYPE_NAME_SINGULAR_Demon: "惡魔",
    MONSTER_TYPE_NAME_PLURAL_Demon: "惡魔",
    MONSTER_TYPE_NAME_SINGULAR_Dragon: "龍",
    MONSTER_TYPE_NAME_PLURAL_Dragon: "龍",
    MONSTER_TYPE_NAME_SINGULAR_Elemental: "元素",
    MONSTER_TYPE_NAME_PLURAL_Elemental: "元素生物",
    MONSTER_TYPE_NAME_SINGULAR_Elf: "Elf",
    MONSTER_TYPE_NAME_PLURAL_Elf: "Elves",
    MONSTER_TYPE_NAME_SINGULAR_Human: "人類",
    MONSTER_TYPE_NAME_PLURAL_Human: "人類",
    MONSTER_TYPE_NAME_SINGULAR_MythicalCreature: "蜮",
    MONSTER_TYPE_NAME_PLURAL_MythicalCreature: "神秘生物",
    MONSTER_TYPE_NAME_SINGULAR_SeaCreature: "海洋生物",
    MONSTER_TYPE_NAME_PLURAL_SeaCreature: "海洋生物",
    MONSTER_TYPE_NAME_SINGULAR_Undead: "亡靈",
    MONSTER_TYPE_NAME_PLURAL_Undead: "亡靈",

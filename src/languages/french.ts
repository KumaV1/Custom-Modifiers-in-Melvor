export const fr = {
    ...
    Settings_Section_Indicators: 'Indicateurs',
    ...
    MONSTER_TYPE_NAME_SINGULAR_Animal: "Animaux",
    MONSTER_TYPE_NAME_PLURAL_Animal: "Animaux",
    MONSTER_TYPE_NAME_SINGULAR_Demon: "Démon",
    MONSTER_TYPE_NAME_PLURAL_Demon: "Démons",
    MONSTER_TYPE_NAME_SINGULAR_Dragon: "Dragon",
    MONSTER_TYPE_NAME_PLURAL_Dragon: "Dragons",
    MONSTER_TYPE_NAME_SINGULAR_Elemental: "Élémentaire",
    MONSTER_TYPE_NAME_PLURAL_Elemental: "Élémentaires",
    MONSTER_TYPE_NAME_SINGULAR_Elf: "Elfe",
    MONSTER_TYPE_NAME_PLURAL_Elf: "Elfes",
    MONSTER_TYPE_NAME_SINGULAR_Human: "Humain",
    MONSTER_TYPE_NAME_PLURAL_Human: "Humains",
    MONSTER_TYPE_NAME_SINGULAR_MythicalCreature: "Créature mythique",
    MONSTER_TYPE_NAME_PLURAL_MythicalCreature: "Créatures mythiques",
    MONSTER_TYPE_NAME_SINGULAR_SeaCreature: "Créature marine",
    MONSTER_TYPE_NAME_PLURAL_SeaCreature: "Créatures marines",
    MONSTER_TYPE_NAME_SINGULAR_Undead: "Mort-vivant",
    MONSTER_TYPE_NAME_PLURAL_Undead: "Mort-vivant",

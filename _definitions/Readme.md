...
**Current mod version: 2.6.0**\
**Definitions last changed version: 2.6.0**
...
Though that doesn't mean that the same info doesn't exist for other monster types as well, assuming you know for sure, that said other monster types are registered (and activated, if necessary).